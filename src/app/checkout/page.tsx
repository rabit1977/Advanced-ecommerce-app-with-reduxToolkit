            ...
            <ul className='py-4 space-y-4'>
              {cart.map((item) => (
                <li key={item.id} className='flex items-center gap-4'>
                  ...
                  <p className='text-sm font-medium ml-auto dark:text-white'>
...
const CheckoutPage = () => {
  ...
  const isPaymentValid = Object.values(paymentInfo).every(
    (field) => field.trim() !== ''
  );
                      ...
                      <label className='flex items-center gap-3 cursor-pointer p-4 border rounded-lg bg-slate-100 dark:bg-slate-800 dark:border-slate-700'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-slate-600 dark:text-slate-300'>
                            5-7 business days - {priceFmt(5.0)}
                          </p>
                        </div>
                      </label>
                      <label className='flex items-center gap-3 cursor-pointer p-4 border rounded-lg bg-slate-100 dark:bg-slate-800 dark:border-slate-700'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-slate-600 dark:text-slate-300'>
                            2-3 business days - {priceFmt(15.0)}
                          </p>
                        </div>
                      </label>
                    </div>
                ...
                <div>
                  ...
                  <div className='mt-4 flex flex-col gap-4'>
                    ...
                    <div className='border p-4 rounded-md dark:border-slate-700'>
                      ...
                      <p className='text-slate-600 dark:text-slate-300'>
                        {paymentInfo.nameOnCard} - Card ending in{' '}
      ...
      <Dialog open={showLeaveConfirm} onOpenChange={setShowLeaveConfirm}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to leave the checkout process? Your progress
              will be lost.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
